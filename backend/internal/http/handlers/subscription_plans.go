	...
	plans := []gin.H{
		{
			...
			"currency":    "USD",
			"interval":    "month",
			"description": "Essential dialysis operations for small units (<10 patients)",
			"features": []string{
		...
		},
		{
			...
			"currency":    "USD",
			"interval":    "month",
			"description": "Comprehensive features for medium units (10-50 patients)",
			"features": []string{
				"Everything in Basic",
				"Lab alerts & basic lab tracking",
		...
		},
		{
			...
			"currency":    "USD",
			"interval":    "month",
			"description": "Full feature set for large centers (50+ patients)",
			"features": []string{
				"Everything in Standard",
				"Full lab module integration",
				"Complete pharmacy management",
				"HR & staff management",
				"Equipment & consumables inventory",
				"Advanced billing features",
				"Imaging integration",
				"CHW program (optional)",
